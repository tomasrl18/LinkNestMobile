 ...
 *
 * Displays a list of links stored in Supabase for the current user.  The list
 * refreshes whenever items are added, updated or deleted via Postgres
 * realtime subscriptions.  Users can also sign out and open the form to
 * create a new link.
 */
