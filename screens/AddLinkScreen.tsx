 ...
 *
 * Collects the URL and optional metadata (title, description, tags, favorite)
 * from the user and inserts a row into the `links` table in Supabase.  Tags
 * should be entered as a comma‑separated list; they will be split into an
 * array before saving.
 */
